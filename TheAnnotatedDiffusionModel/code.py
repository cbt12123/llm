...
from einops import rearrange, reduce        # 不确定reduce是不是这导入的，再看看
...
class Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        sim = einsum("b h d i, b h d j -> b h i d", q, k)
...
class Unet(nn.Module):
    def __init__(self,
        ...
        dims = [init_dim, *map(lambda m: dim * m, dim_mumlts)]
